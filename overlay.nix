...
with insane-pkgs; rec {
  ...
  nix-beautify = import (fetchTarball "https://github.com/nixcloud/nix-beautify/archive/5ea527d95aaae3a131882f9f5d5babfa28ddebd7.tar.gz");
  buildkite-latest = super.callPackage ./pkgs/buildkite { };
  inherit insane-lib buildkite-pipeline;
